...
# download URLs
export PANEL_DL_URL="https://github.com/pterodactyl/panel/releases/download/v1.11.1/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/garuuuuuuuuuuuuuuuuuuuux/huftttttttttttt"}
